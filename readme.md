...
* 注重可靠，随用随有可7*24不间断服务，且不想受UDP协议Qos之苦<br>
* 注重可控，希望客户端一点配置，且随时随地控制服务开启/关闭<br>
* 注重环保，希望不要装一堆东东，体量小巧 allinone，希望高性能且资源占用最少<br>
* ......如果这都是你想要的！请耐心继续往下看<br>
# 重要的事情说三遍！
...
4、支持编译为mini版本，不再静态编译openssl；对openssl库从0.9.8~1.1.1的全系动态兼容，二进制包缩小为
